...
cl = LINETCR.LINE()
cl.login(token="EnKR562oViqKUPg0I41f.RJOdW/BYfRpBgJJN9dXWJW.q0xXi02/T/t/XT5dMqbCCJbzfI/wGcwYNiKlcNAp5Bo=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnwJ64wFTVEwJSBYtCk3./oO+6tkFVXl4XuXG7vVSyW.HVxlzkMByg26CmjjWbpMiFN17jQzdf1V9gLqExVc3mU=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Ena22KoX1OTv9MP2SaJ3.JXugAKnFZMalCTN4wPkfyW.1/WXZsqx07F8cG0DgbwSoBGxVUAFykhVhOGRMZtGCD4=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="En4fWJjBGlESgAdgIGVa.lVGGVPi7vq/XVgIklkw4IG.PVGWasScPeXFDjti7Yfdp85pk2Ar7Np3TY/nuE0qS/w=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EniysX9Ohwa5xcCXwUh0.5pE6NazAOUF9w5vXC6uyCa.n2Z6po1ztKy5jP47W3CrxusTrKW9s8ULKbOD+XA4f2c=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EnRfMfH55BVrkYnBqH56.jdiU6li3FfXFAOQG22kmDG.+9Pw2RTM6BIK+XjpAsJzaQcDRKm5hmTA1fYokE2HRXY=")
ki5.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"ub0a437d8c41b2949e1de3f884ac32e02","uae3a03c3e6f216b3db1a38e7f43c708f"] #jika mau menambahkan bot jgn lupa taroh disini cth. ki5mid didalem [] jangan lupa tanda koma
admsa = "uae3a03c3e6f216b3db1a38e7f43c708f"
wait = {
    'contact':False,
    'autoJoin':True,

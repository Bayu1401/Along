...
cl = LINETCR.LINE()
cl.login(token="EmaqTwaQRaxRwupPlZ9c.IRCvt2JuSjq7DRjSbkuSRa.8p/x8OK2cjPwvlrXnQeJTFdX5/jJfE0u3NT/S4hnJgQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmcBSKvygGbOrwWUnJi2.RGby3qdS/GgqCEuZMp0DyG.i1HU0sgldZgx5+t83TjFXWLw5lVIUG6cQaCgcwJ+W24=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EmR8o2yHJoW1S4mXFnXb.GxfofPxSgPVRWJCJW24scW.K7xtgABMHM6brr2+XAgPLeKJrrcIw4UWqm8uYnDRADg=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmoOTmoxOVxTJQoqpqMe.hIq97cnmuA78lQfYMVMCxG.Ajdpd/a+GdhgvsFTwuVNAXvHCFuPF0+tNcjvXtBFflo=")
ki3.loginResult()
...
#ki5 = LINETCR.LINE()
#ki5.login(token="EmzrcQ6HBv0u649XdLdb.GxfofPxSgPVRWJCJW24scW.QDtvPAXx3xq63Pi/8T4p5oJPgMZj4CjnRYJjzy2ztZ8=")
#ki5.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,"ub0a437d8c41b2949e1de3f884ac32e02","u81714e1695ec1a9bebc23723c36e120b"] #jika mau menambahkan bot jgn lupa taroh disini cth. ki5mid didalem [] jangan lupa tanda koma
admsa = "u81714e1695ec1a9bebc23723c36e120b"
wait = {
    'contact':False,
    'autoJoin':False,
    ...
    line.me/ti/p/~.whome_""",
    "lang":"JP",
    "comment":"Autolike by line.me/ti/p/~.whome_",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
           ...
           for posts in cl.activity(1)["result"]["posts"]:
             if posts["postInfo"]["liked"] is False:
                if wait["likeOn"] == True:
                   ...
                   ki.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1003)
                   ki2.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1003)
                   ki3.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1004)
                   ki4.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1004)
                   #ki5.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1005)
        ...
        if op.type == 13:
                if mid in op.param3:
                    if wait["autoJoin"] == True:
                        ...
                        print "Bot 1 Join"
                        cl.sendText(op.param1,'Terimakasih sudah invite saya')
        ...
        if op.type == 13:
                if mid in op.para3:
                    if wait["autoJoin"] == False:
                        cl.acceptGroupInvitation(op.param1)
                        print "Bot akan left"
                        cl.sendText(op.param1,'Im in offline right now..')
                        cl.sendText(op.param1,'contact me laters, after me online .. then ask me to join your groups..\nthanks..')
...
#---------------------------------------------------------------------------------------------------------------------------------------
                ...
                #ki7.sendMessage(msg)
#---------------------------------------------------------------------------------------------------------------------------------------
            elif msg.text in["Ats","hm","Hm","wtf","Wtf"]:
                group = cl.getGroup(msg.to)
                ...
                cl.sendMessage(cnt)
#---------------------------------------------------------------------------------------------------------------------------------------
            elif msg.text in["Jembot","@Tag","@Tags","@tag","@tags"]:
                group = cl.getGroup(msg.to)
                nama = [contact.mid for contact in group.members]
...
#---------------------------------------------------------------------------------------------------------------------------------------
                ...
                try:
                    cl.sendImageWithURL(msg.tp, path)
...
#---------------------------------------------------------------------------------------------------------------------------------------
            ...
            elif '/wk ' in msg.text.lower():
                  try:
                      wiki = msg.text.lower().replace("/wk ","")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,"Target Locked 􀜁􀇔􏿿")
                            except:
                                cl.sendText(msg.to,"Error")
#---------------------------------------------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,""  +  str(ginfo.name)  +"")
               ...
               if targets == []:
                ...
                for target in targets:
                 try:
                  ...
                  ki.sendText(msg.to,"Nenen 􀜁􀇔􏿿􀜁􀇔􏿿􀜁􀇔􏿿😋��")
                  break
                 except:
                  break
              elif "del" in cmd:
              ...
              if cmd == "tt mau?":
               ...
               if targets == []:
                ...
                for target in targets:
                 try:
                  mimic["target"][target] = True
                  ki.sendText(msg.to,"Nenen 􀜁􀇔��􀜁􀇔􏿿􀜁􀇔􏿿😋��")
                  break
                 except:
                  break
              elif "del" in cmd:
